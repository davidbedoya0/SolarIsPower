...
proteccionesAC = {
    ...
    "capacidadRupturaA":[ 30, 30, 30, 30, 30,
    30, 35, 35,
    65, 65,
    30, 30, 30, 30, 30, 
    30, 
    ...
    "capacidadRupturaB":[ 18, 18, 18, 18, 18,
    18, 22, 22,
    30, 30,
    18, 18, 18, 18, 18, 
    18, 
    ...
    "capacidadRupturaC":[ 14, 14, 14, 14, 14,
    14, 18, 18,
    25, 25,
    14, 14, 14, 14, 14, 
    14, 
...
WiresISO = {
    ...
    "seccion":[0.8230, 1.31, 2.080, 3.310, 5.270, 8.350, 9.93, 
        2.080, 3.310, 5.270, 8.350, 13.3, 
        21.2, 33.6, 53.5, 67.4, 85, 
        107, 127, 152, 177.3, 202.7, 
        253.4, 9.93, 2.08, 
        3.310, 5.270, 8.350, 13.3, 
        21.2, 33.6, 53.5, 67.4,
        107, 13.3, 21.2, 33.6, 
        53.5, 67.4, 85, 107, 
        127, 152, 177.3, 
...
WiresDCIso={
    ...
    "seccion":[53.5, 67.4, 13.3, 3.31, 5.26],
